...
| release | Tagged commit and GitHub release with the binaries for one version. Every version goes to npm. Stable versions also get the Homebrew formula. | publish, ship, cut |
